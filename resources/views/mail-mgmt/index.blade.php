...
@section('action-content')
    ...
    <section class="content">
      <div class="row">
        <div class="col-md-3">
          <a href="{{ route('mail-management.create') }}" class="btn btn-primary btn-block margin-bottom">Compose</a>
          ...
          <div class="box box-solid">
            ...
            <div class="box-body no-padding">
              <ul class="nav nav-pills nav-stacked">
                <li class="active"><a href="{{ route('mail-management.index') }}"><i class="fa fa-inbox"></i> Inbox
